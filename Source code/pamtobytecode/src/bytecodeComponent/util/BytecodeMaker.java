...
import bytecodeComponent.GeneralInformation;
import bytecodeComponent.ConstantPool;
import bytecodeComponent.Methods;
...
public class BytecodeMaker {
	...
	private void initialization() throws Exception
	{
		...
		CP.put(14, Constant.UTF8(ClassName + ".txt")); //파일의 이름
		...
		int SourceFileNameIndex = CP.IndexofUTF8(ClassName + ".txt");
